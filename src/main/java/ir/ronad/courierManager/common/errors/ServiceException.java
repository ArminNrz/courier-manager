...
public class ServiceException extends AbstractThrowableProblem {
    ...
    public ServiceException(String defaultMessage, String entityName, String errorKey) {
        this(ErrorConstants.DEFAULT_TYPE, defaultMessage, entityName, errorKey);
    }

    public ServiceException(URI type, String defaultMessage, String entityName, String errorKey) {
